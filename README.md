...
- **Vue 2 des bulles** : tant que **Ctrl** est enfoncé pendant le survol, les bulles se rangent toutes sur une même verticale, à intervalles réguliers, avec des pointes inclinées qui ne se croisent pas. Quand il y en a trop pour la hauteur disponible, seules quelques-unes, réparties dans la liste, sont montrées. Relâcher Ctrl ramène la **vue 1**, chaque bulle en face de son paragraphe.
